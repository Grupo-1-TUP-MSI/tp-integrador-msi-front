...
export const darkColorsTheme: ITheme = {
  ...
  disable: '#7e7e7e',
  disabledBg: '#3C3C3C44',
  layoutBodyBg: '#3C3C3C88',
  layoutHeaderBg: '#3C3C3C88',
  layoutSiderBg: '#3C3C3C',
  inputPlaceholder: 'rgba(255, 255, 255, 0.5)',
  itemHoverBg: '#3C3C3C44',
  backgroundColorBase: '#3C3C3C44',
  avatarBg: '#3C3C3C44',
  alertTextColor: '#000',
  breadcrumb: '#a9a9a9',
  icon: '#a9a9a9',
