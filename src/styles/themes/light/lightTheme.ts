...
export const lightColorsTheme: ITheme = {
  primary: '#73C364',
  primary1: '#f5f5f5',
  primaryGradient: 'linear-gradient(211.49deg, #006CCF 15.89%, #73C364 48.97%)',
  light: '#C5D3E0',
  secondary: '#0085FF',
  error: '#FF5252',
  warning: '#FFB155',
  ...
  layoutSiderBg: 'linear-gradient(261.31deg, #73C364 -29.57%, #73C364 121.11%)',
